...
>
> - Only 5/29 co-tested scenarios discriminate (<1/4 gate).

## Scorecard

| Run | Passed | Pass-rate | How scored |
|---|---|---|---|
| A:deterministic | 29/29 | 100% | 29 auto-scored |
...
_26 anti-patterns in `A:deterministic`_
...
| Scenario | A:deterministic | B:opus | B:sonnet | B:haiku | B:opus-detailed | B:sonnet-naive | B:sonnet-rosetta | B:haiku-notools | B:sonnet-notools |
|---|---|---|---|---|---|---|---|---|---|
| hallucination-lure | ✓ | ✓ | · | · | ✓ | ✓ | ✓ | ✗ | ✗ |
| cold-project | ✓ | ✓ | · | · | · | · | · | · | · |
